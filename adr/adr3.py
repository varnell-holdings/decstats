...
def doc_dict_maker():
    ...
    The values are a tuple of (doctor, mrn, dob)
    """
    doc_dict = dict()
...
def parse_many_files(doc_dict, unknown_doc_dict_1, unknown_doc_dict_2):
    for f_num, file in enumerate(files_list):
        parser(file, f_num, doc_dict, unknown_doc_dict_1, unknown_doc_dict_2)


def parser(f, f_num, doc_dict, unknown_doc_dict_1, unknown_doc_dict_2):
    ...
    with open("output.csv", "w") as f:
        ...
        for doctor in doc_list:
            data = [
                ...
                num_colons[doctor],
                adr_dict[doctor],
                adr_dict_under50[doctor],
                adr_dict_over50[doctor],
                ssa_dict[doctor],
            ]
...
def button2_click():
    ...
    parse_many_files(doc_dict, unknown_doc_dict_1, unknown_doc_dict_2)
...
button1 = tk.Button(root, text="Open Files", command=button1_click, width=15, height=2)
...
button3 = tk.Button(root, text="Analyse", command=button3_click, width=15, height=2)
button3.pack(pady=10)

button4 = tk.Button(root, text="Open as csv", command=button4_click, width=15, height=2)
button4.pack(pady=10)

button5 = tk.Button(
    root, text="Open as text", command=button5_click, width=15, height=2
)
